...
class ResBlock(nn.Module):
    def __init__(self, in_channel, out_channel, stride=1, downsample=None, dropout=0.0):
    ...
    def forward(self, x):
        ...
        out = self.relu(self.downsample(x) + self.drop(self.bn2(self.conv2(out))))
...
class DCNet(nn.Module):
    def __init__(self, dim=64, args=None):
        ...
        self.mlp = MLP(ndims[3], 1, dropout=args.classifier_drop)
